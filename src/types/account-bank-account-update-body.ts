...
} from "./account-bank-account-update-body-documents";
import {
...
} from "./account-bank-account-update-body-metadata-obj0";
 ...
 */
export type AccountBankAccountUpdateBody = {
  /**
  ...
  [additionalProperty: string]:
    ...
    | (string | undefined)
    | (boolean | undefined)
    | (AccountBankAccountUpdateBodyDocuments | undefined)
    | (string | undefined)
    | (string | undefined)
    | (string[] | undefined)
    | ((AccountBankAccountUpdateBodyMetadataObj0 | string) | undefined)
    | (string | undefined)
    | any
    | null
    | undefined;
...
/**
 * @internal
 * AccountBankAccountUpdateBody without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$AccountBankAccountUpdateBody = {
  ...
  [additionalProperty: string]:
    ...
    | (string | undefined)
    | (boolean | undefined)
    | (External$AccountBankAccountUpdateBodyDocuments | undefined)
    | (string | undefined)
    | (string | undefined)
    | (string[] | undefined)
    | ((External$AccountBankAccountUpdateBodyMetadataObj0 | string) | undefined)
    | (string | undefined)
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object AccountBankAccountUpdateBody
 */
const SchemaIn$AccountBankAccountUpdateBody: z.ZodType<
  AccountBankAccountUpdateBody, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$AccountBankAccountUpdateBody
 */
const SchemaOut$AccountBankAccountUpdateBody: z.ZodType<
  External$AccountBankAccountUpdateBody, // output type of this zod object
  z.ZodTypeDef,
  AccountBankAccountUpdateBody // the object to be transformed
> = z
  .object({
...
export const Schemas$AccountBankAccountUpdateBody = {
  in: SchemaIn$AccountBankAccountUpdateBody,
  out: SchemaOut$AccountBankAccountUpdateBody,
};
