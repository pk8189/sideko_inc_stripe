...
export type PaymentMethodDetailsInteracPresentReceipt = {
   ...
   */
  accountType?: ("checking" | "savings" | "unknown") | undefined;
  /**
...
/**
 * @internal
 * PaymentMethodDetailsInteracPresentReceipt without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$PaymentMethodDetailsInteracPresentReceipt = {
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object PaymentMethodDetailsInteracPresentReceipt
 */
const SchemaIn$PaymentMethodDetailsInteracPresentReceipt: z.ZodType<
  PaymentMethodDetailsInteracPresentReceipt, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$PaymentMethodDetailsInteracPresentReceipt
 */
const SchemaOut$PaymentMethodDetailsInteracPresentReceipt: z.ZodType<
  External$PaymentMethodDetailsInteracPresentReceipt, // output type of this zod object
  z.ZodTypeDef,
  PaymentMethodDetailsInteracPresentReceipt // the object to be transformed
> = z
  .object({
    accountType: z.enum(["checking", "savings", "unknown"]).optional(),
...
export const Schemas$PaymentMethodDetailsInteracPresentReceipt = {
  in: SchemaIn$PaymentMethodDetailsInteracPresentReceipt,
  out: SchemaOut$PaymentMethodDetailsInteracPresentReceipt,
};
