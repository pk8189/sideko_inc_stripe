...
import {
  External$PaymentPagesCheckoutSessionInvoiceSettingsMetadata,
  PaymentPagesCheckoutSessionInvoiceSettingsMetadata,
  Schemas$PaymentPagesCheckoutSessionInvoiceSettingsMetadata,
} from "./payment-pages-checkout-session-invoice-settings-metadata";
...
/**
 * @internal
 * PaymentPagesCheckoutSessionInvoiceSettings without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$PaymentPagesCheckoutSessionInvoiceSettings = {
  account_tax_ids?:
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object PaymentPagesCheckoutSessionInvoiceSettings
 */
const SchemaIn$PaymentPagesCheckoutSessionInvoiceSettings: z.ZodType<
  PaymentPagesCheckoutSessionInvoiceSettings, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
    ...
    metadata: Schemas$PaymentPagesCheckoutSessionInvoiceSettingsMetadata.in
      .nullable()
      .optional(),
    rendering_options:
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$PaymentPagesCheckoutSessionInvoiceSettings
 */
const SchemaOut$PaymentPagesCheckoutSessionInvoiceSettings: z.ZodType<
  External$PaymentPagesCheckoutSessionInvoiceSettings, // output type of this zod object
  z.ZodTypeDef,
  PaymentPagesCheckoutSessionInvoiceSettings // the object to be transformed
> = z
  .object({
    accountTaxIds: z
      .array(
    ...
    metadata: Schemas$PaymentPagesCheckoutSessionInvoiceSettingsMetadata.out
      .nullable()
      .optional(),
    renderingOptions:
...
export const Schemas$PaymentPagesCheckoutSessionInvoiceSettings = {
  in: SchemaIn$PaymentPagesCheckoutSessionInvoiceSettings,
  out: SchemaOut$PaymentPagesCheckoutSessionInvoiceSettings,
};
