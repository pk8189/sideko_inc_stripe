 ...
 */
export type IssuingDisputeUpdateBodyEvidenceCanceledObj0 = {
...
/**
 * @internal
 * IssuingDisputeUpdateBodyEvidenceCanceledObj0 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$IssuingDisputeUpdateBodyEvidenceCanceledObj0 = {
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object IssuingDisputeUpdateBodyEvidenceCanceledObj0
 */
const SchemaIn$IssuingDisputeUpdateBodyEvidenceCanceledObj0: z.ZodType<
  IssuingDisputeUpdateBodyEvidenceCanceledObj0, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$IssuingDisputeUpdateBodyEvidenceCanceledObj0
 */
const SchemaOut$IssuingDisputeUpdateBodyEvidenceCanceledObj0: z.ZodType<
  External$IssuingDisputeUpdateBodyEvidenceCanceledObj0, // output type of this zod object
  z.ZodTypeDef,
  IssuingDisputeUpdateBodyEvidenceCanceledObj0 // the object to be transformed
> = z
  .object({
...
export const Schemas$IssuingDisputeUpdateBodyEvidenceCanceledObj0 = {
  in: SchemaIn$IssuingDisputeUpdateBodyEvidenceCanceledObj0,
  out: SchemaOut$IssuingDisputeUpdateBodyEvidenceCanceledObj0,
};
