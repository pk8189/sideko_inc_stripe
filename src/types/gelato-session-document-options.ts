...
/**
 * @internal
 * GelatoSessionDocumentOptions without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$GelatoSessionDocumentOptions = {
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object GelatoSessionDocumentOptions
 */
const SchemaIn$GelatoSessionDocumentOptions: z.ZodType<
  GelatoSessionDocumentOptions, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$GelatoSessionDocumentOptions
 */
const SchemaOut$GelatoSessionDocumentOptions: z.ZodType<
  External$GelatoSessionDocumentOptions, // output type of this zod object
  z.ZodTypeDef,
  GelatoSessionDocumentOptions // the object to be transformed
> = z
  .object({
    allowedTypes: z
      .array(z.enum(["driving_license", "id_card", "passport"]))
...
export const Schemas$GelatoSessionDocumentOptions = {
  in: SchemaIn$GelatoSessionDocumentOptions,
  out: SchemaOut$GelatoSessionDocumentOptions,
};
