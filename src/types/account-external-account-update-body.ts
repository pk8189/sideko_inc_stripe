...
} from "./account-external-account-update-body-documents";
import {
...
} from "./account-external-account-update-body-metadata-obj0";
 ...
 */
export type AccountExternalAccountUpdateBody = {
  /**
  ...
  [additionalProperty: string]:
    ...
    | (string | undefined)
    | (boolean | undefined)
    | (AccountExternalAccountUpdateBodyDocuments | undefined)
    | (string | undefined)
    | (string | undefined)
    | (string[] | undefined)
    | ((AccountExternalAccountUpdateBodyMetadataObj0 | string) | undefined)
    | (string | undefined)
    | any
    | null
    | undefined;
...
/**
 * @internal
 * AccountExternalAccountUpdateBody without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$AccountExternalAccountUpdateBody = {
  ...
  [additionalProperty: string]:
    ...
    | (string | undefined)
    | (boolean | undefined)
    | (External$AccountExternalAccountUpdateBodyDocuments | undefined)
    | (string | undefined)
    | (string | undefined)
    | (string[] | undefined)
    | (
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object AccountExternalAccountUpdateBody
 */
const SchemaIn$AccountExternalAccountUpdateBody: z.ZodType<
  AccountExternalAccountUpdateBody, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$AccountExternalAccountUpdateBody
 */
const SchemaOut$AccountExternalAccountUpdateBody: z.ZodType<
  External$AccountExternalAccountUpdateBody, // output type of this zod object
  z.ZodTypeDef,
  AccountExternalAccountUpdateBody // the object to be transformed
> = z
  .object({
...
export const Schemas$AccountExternalAccountUpdateBody = {
  in: SchemaIn$AccountExternalAccountUpdateBody,
  out: SchemaOut$AccountExternalAccountUpdateBody,
};
