...
/**
 * @internal
 * SetupAttemptPaymentMethodDetailsIdeal without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$SetupAttemptPaymentMethodDetailsIdeal = {
  bank?:
    | (
        | "abn_amro"
        | "asn_bank"
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object SetupAttemptPaymentMethodDetailsIdeal
 */
const SchemaIn$SetupAttemptPaymentMethodDetailsIdeal: z.ZodType<
  SetupAttemptPaymentMethodDetailsIdeal, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$SetupAttemptPaymentMethodDetailsIdeal
 */
const SchemaOut$SetupAttemptPaymentMethodDetailsIdeal: z.ZodType<
  External$SetupAttemptPaymentMethodDetailsIdeal, // output type of this zod object
  z.ZodTypeDef,
  SetupAttemptPaymentMethodDetailsIdeal // the object to be transformed
> = z
  .object({
    bank: z
      .enum([
...
export const Schemas$SetupAttemptPaymentMethodDetailsIdeal = {
  in: SchemaIn$SetupAttemptPaymentMethodDetailsIdeal,
  out: SchemaOut$SetupAttemptPaymentMethodDetailsIdeal,
};
