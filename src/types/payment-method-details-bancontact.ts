...
/**
 * @internal
 * PaymentMethodDetailsBancontact without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$PaymentMethodDetailsBancontact = {
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object PaymentMethodDetailsBancontact
 */
const SchemaIn$PaymentMethodDetailsBancontact: z.ZodType<
  PaymentMethodDetailsBancontact, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$PaymentMethodDetailsBancontact
 */
const SchemaOut$PaymentMethodDetailsBancontact: z.ZodType<
  External$PaymentMethodDetailsBancontact, // output type of this zod object
  z.ZodTypeDef,
  PaymentMethodDetailsBancontact // the object to be transformed
> = z
  .object({
...
export const Schemas$PaymentMethodDetailsBancontact = {
  in: SchemaIn$PaymentMethodDetailsBancontact,
  out: SchemaOut$PaymentMethodDetailsBancontact,
};
