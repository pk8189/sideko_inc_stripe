...
/**
 * @internal
 * InvoicesResourcePretaxCreditAmount without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$InvoicesResourcePretaxCreditAmount = {
  amount: number;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object InvoicesResourcePretaxCreditAmount
 */
const SchemaIn$InvoicesResourcePretaxCreditAmount: z.ZodType<
  InvoicesResourcePretaxCreditAmount, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$InvoicesResourcePretaxCreditAmount
 */
const SchemaOut$InvoicesResourcePretaxCreditAmount: z.ZodType<
  External$InvoicesResourcePretaxCreditAmount, // output type of this zod object
  z.ZodTypeDef,
  InvoicesResourcePretaxCreditAmount // the object to be transformed
> = z
  .object({
    amount: z.number().int(),
...
export const Schemas$InvoicesResourcePretaxCreditAmount = {
  in: SchemaIn$InvoicesResourcePretaxCreditAmount,
  out: SchemaOut$InvoicesResourcePretaxCreditAmount,
};
