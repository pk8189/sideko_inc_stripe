import {
  ...
  External$ChargeDisputeCreateBodyEvidenceEnhancedEvidenceObj0,
  Schemas$ChargeDisputeCreateBodyEvidenceEnhancedEvidenceObj0,
} from "./charge-dispute-create-body-evidence-enhanced-evidence-obj0";
 ...
 */
export type ChargeDisputeCreateBodyEvidence = {
  ...
  enhancedEvidence?:
    | (ChargeDisputeCreateBodyEvidenceEnhancedEvidenceObj0 | string)
    | undefined;
...
/**
 * @internal
 * ChargeDisputeCreateBodyEvidence without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$ChargeDisputeCreateBodyEvidence = {
  ...
  enhanced_evidence?:
    | (External$ChargeDisputeCreateBodyEvidenceEnhancedEvidenceObj0 | string)
    | undefined;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object ChargeDisputeCreateBodyEvidence
 */
const SchemaIn$ChargeDisputeCreateBodyEvidence: z.ZodType<
  ChargeDisputeCreateBodyEvidence, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
    ...
    enhanced_evidence: z
      .union([
        Schemas$ChargeDisputeCreateBodyEvidenceEnhancedEvidenceObj0.in,
        z.string(),
      ])
      .optional(),
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$ChargeDisputeCreateBodyEvidence
 */
const SchemaOut$ChargeDisputeCreateBodyEvidence: z.ZodType<
  External$ChargeDisputeCreateBodyEvidence, // output type of this zod object
  z.ZodTypeDef,
  ChargeDisputeCreateBodyEvidence // the object to be transformed
> = z
  .object({
    ...
    enhancedEvidence: z
      .union([
        Schemas$ChargeDisputeCreateBodyEvidenceEnhancedEvidenceObj0.out,
        z.string(),
      ])
      .optional(),
...
export const Schemas$ChargeDisputeCreateBodyEvidence = {
  in: SchemaIn$ChargeDisputeCreateBodyEvidence,
  out: SchemaOut$ChargeDisputeCreateBodyEvidence,
};
