...
const res = await client.customer.delete({ data: {}, customer: "string" });
```
...
const res = await client.customer.list({ data: {} });
```
...
const res = await client.customer.search({ data: {}, query: "string" });
```
...
const res = await client.customer.get({ data: {}, customer: "string" });
```
