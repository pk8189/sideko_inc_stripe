...
} from "@sideko-inc/stripe/types/checkout-session-create-body-adaptive-pricing";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-after-expiration";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-automatic-tax";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-consent-collection";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-custom-fields-item";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-custom-text";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-customer-update";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-discounts-item";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-invoice-creation";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-line-items-item";
import {
  CheckoutSessionCreateBodyMetadata,
  External$CheckoutSessionCreateBodyMetadata,
  Schemas$CheckoutSessionCreateBodyMetadata,
} from "@sideko-inc/stripe/types/checkout-session-create-body-metadata";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-optional-items-item";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-payment-intent-data";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-payment-method-data";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-payment-method-options";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-permissions";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-phone-number-collection";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-saved-payment-method-options";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-setup-intent-data";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-shipping-address-collection";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-shipping-options-item";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-subscription-data";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-create-body-tax-id-collection";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-update-body-collected-information";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-update-body-metadata-obj0";
import {
...
} from "@sideko-inc/stripe/types/checkout-session-update-body-shipping-options-arr0-item";
