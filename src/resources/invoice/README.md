...
const res = await client.invoice.delete({ data: {}, invoice: "string" });
```
...
const res = await client.invoice.list({ data: {} });
```
...
const res = await client.invoice.search({ data: {}, query: "string" });
```
...
const res = await client.invoice.get({ data: {}, invoice: "string" });
```
