...
const res = await client.creditNote.list({ data: {} });
```
...
const res = await client.creditNote.preview1({ data: {}, invoice: "string" });
```
...
const res = await client.creditNote.preview({ data: {}, invoice: "string" });
```
...
const res = await client.creditNote.lines({ data: {}, creditNote: "string" });
```
...
const res = await client.creditNote.get({ data: {}, id: "string" });
```
