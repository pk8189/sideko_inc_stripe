...
describe("tests client.treasury.financialAccounts.feature.list", () => {
  test.concurrent(
    "GET /v1/treasury/financial_accounts/{financial_account}/features | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
...
describe("tests client.treasury.financialAccounts.feature.create", () => {
  test.concurrent(
    "POST /v1/treasury/financial_accounts/{financial_account}/features | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
