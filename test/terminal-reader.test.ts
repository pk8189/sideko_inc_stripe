...
describe("tests client.terminal.reader.delete", () => {
  test.concurrent(
    "DELETE /v1/terminal/readers/{reader} | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      ...
      const [rawResponse, response] = await Promise.all([
        client.terminal.reader
          .delete({ data: {}, reader: "string" })
          .asResponse(),
        client.terminal.reader.delete({ data: {}, reader: "string" }),
      ]);
...
describe("tests client.terminal.reader.list", () => {
  test.concurrent(
    "GET /v1/terminal/readers | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
      ...
      // Get both raw response for status and parsed response for data
      const [rawResponse, response] = await Promise.all([
        client.terminal.reader.list({ data: {} }).asResponse(),
        client.terminal.reader.list({ data: {} }),
      ]);
      expect(rawResponse.status).toBe(200); // Exact status code match
      // Response body automatically validated by Zod schema during deserialization
      expect(response).toBeDefined();
...
describe("tests client.terminal.reader.get", () => {
  test.concurrent(
    "GET /v1/terminal/readers/{reader} | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
      ...
      // Get both raw response for status and parsed response for data
      const [rawResponse, response] = await Promise.all([
        client.terminal.reader.get({ data: {}, reader: "string" }).asResponse(),
        client.terminal.reader.get({ data: {}, reader: "string" }),
      ]);
      expect(rawResponse.status).toBe(200); // Exact status code match
      // Response body automatically validated by Zod schema during deserialization
      expect(response).toBeDefined();
...
describe("tests client.terminal.reader.update", () => {
  test.concurrent(
    "POST /v1/terminal/readers/{reader} | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.terminal.reader.cancelAction", () => {
  test.concurrent(
    "POST /v1/terminal/readers/{reader}/cancel_action | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.terminal.reader.refundPayment", () => {
  test.concurrent(
    "POST /v1/terminal/readers/{reader}/refund_payment | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
