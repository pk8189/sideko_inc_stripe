...
describe("tests client.testHelper.issuing.authorization.capture", () => {
  test.concurrent(
    "POST /v1/test_helpers/issuing/authorizations/{authorization}/capture | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.testHelper.issuing.authorization.expire", () => {
  test.concurrent(
    "POST /v1/test_helpers/issuing/authorizations/{authorization}/expire | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.testHelper.issuing.authorization.reverse", () => {
  test.concurrent(
    "POST /v1/test_helpers/issuing/authorizations/{authorization}/reverse | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
