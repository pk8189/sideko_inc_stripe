...
describe("tests client.paymentIntent.list", () => {
  test.concurrent(
    "GET /v1/payment_intents | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      ...
      const [rawResponse, response] = await Promise.all([
        client.paymentIntent.list({ data: {} }).asResponse(),
        client.paymentIntent.list({ data: {} }),
      ]);
...
describe("tests client.paymentIntent.search", () => {
  test.concurrent(
    "GET /v1/payment_intents/search | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
      ...
      // Get both raw response for status and parsed response for data
      const [rawResponse, response] = await Promise.all([
        client.paymentIntent.search({ data: {}, query: "string" }).asResponse(),
        client.paymentIntent.search({ data: {}, query: "string" }),
      ]);
      expect(rawResponse.status).toBe(200); // Exact status code match
      // Response body automatically validated by Zod schema during deserialization
      expect(response).toBeDefined();
...
describe("tests client.paymentIntent.get", () => {
  test.concurrent(
    "GET /v1/payment_intents/{intent} | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
      ...
      // Get both raw response for status and parsed response for data
      const [rawResponse, response] = await Promise.all([
        client.paymentIntent.get({ data: {}, intent: "string" }).asResponse(),
        client.paymentIntent.get({ data: {}, intent: "string" }),
      ]);
      expect(rawResponse.status).toBe(200); // Exact status code match
      // Response body automatically validated by Zod schema during deserialization
      expect(response).toBeDefined();
...
describe("tests client.paymentIntent.update", () => {
  test.concurrent(
    "POST /v1/payment_intents/{intent} | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.paymentIntent.applyCustomerBalance", () => {
  test.concurrent(
    "POST /v1/payment_intents/{intent}/apply_customer_balance | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.paymentIntent.cancel", () => {
  test.concurrent(
    "POST /v1/payment_intents/{intent}/cancel | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.paymentIntent.capture", () => {
  test.concurrent(
    "POST /v1/payment_intents/{intent}/capture | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.paymentIntent.confirm", () => {
  test.concurrent(
    "POST /v1/payment_intents/{intent}/confirm | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
...
describe("tests client.paymentIntent.verifyMicrodeposits", () => {
  test.concurrent(
    "POST /v1/payment_intents/{intent}/verify_microdeposits | testId: success_default | Success test with response schema validation. Expects status code 200",
    async () => {
      const client = new Stripe({
        username: "API_USERNAME",
        password: "API_PASSWORD",
